...
public class MediaCodecVideoRenderer extends MediaCodecRenderer
  ...
  protected void onEnabled(boolean joining, boolean mayRenderStartOfStream)
      throws ExoPlaybackException {
    Log.d(TAG_YOHAN, "MediaCodecVideoRenderer.onEnabled() - joining: " + joining + ", mayRenderStartOfStream: " + mayRenderStartOfStream);
  ...
  protected void onStarted() {
    Log.d(TAG_YOHAN, "MediaCodecVideoRenderer.onStarted() - 비디오 렌더링 시작");
    super.onStarted();
    droppedFrames = 0;
  ...
  protected boolean processOutputBuffer(
      ...
      Format format)
      throws ExoPlaybackException {
    // 30프레임마다 한 번씩 로그 출력 (성능 영향 최소화)
    if (decoderCounters.renderedOutputBufferCount % 30 == 0) {
      Log.d(TAG_YOHAN, "MediaCodecVideoRenderer.processOutputBuffer() - 프레임 처리 중, presentationTimeUs: " + bufferPresentationTimeUs + ", renderedCount: " + decoderCounters.renderedOutputBufferCount);
    }
  ...
  protected void renderOutputBufferV21(
    ...
    // 30프레임마다 한 번씩 로그 출력 (성능 영향 최소화)
    if (decoderCounters.renderedOutputBufferCount % 30 == 0) {
      Log.d(TAG_YOHAN, "MediaCodecVideoRenderer.renderOutputBufferV21() - 프레임 렌더링, presentationTimeUs: " + presentationTimeUs + ", renderedCount: " + (decoderCounters.renderedOutputBufferCount + 1));
    }
    TraceUtil.beginSection("releaseOutputBuffer");
  ...
  private void notifyRenderedFirstFrame() {
    Log.d(TAG_YOHAN, "MediaCodecVideoRenderer.notifyRenderedFirstFrame() - 첫 번째 프레임 렌더링 완료!");
