...
public abstract class BaseRenderer implements Renderer, RendererCapabilities {
  ...
  public final void enable(
    ...
    Log.d(TAG_YOHAN, "BaseRenderer.enable() - 렌더러: " + getClass().getSimpleName() + ", trackType: " + trackType + ", joining: " + joining);
    checkState(state == STATE_DISABLED);
    this.configuration = configuration;
    this.mediaPeriodId = mediaPeriodId;
    state = STATE_ENABLED;
    Log.d(TAG_YOHAN, "BaseRenderer.enable() - 상태 변경: STATE_DISABLED -> STATE_ENABLED, onEnabled() 호출");
  ...
  public final void start() throws ExoPlaybackException {
    Log.d(TAG_YOHAN, "BaseRenderer.start() - 렌더러: " + getClass().getSimpleName() + ", 상태 변경: STATE_ENABLED -> STATE_STARTED");
  ...
  public final void stop() {
    Log.d(TAG_YOHAN, "BaseRenderer.stop() - 렌더러: " + getClass().getSimpleName() + ", 상태 변경: STATE_STARTED -> STATE_ENABLED");
  ...
  public final void disable() {
    Log.d(TAG_YOHAN, "BaseRenderer.disable() - 렌더러: " + getClass().getSimpleName() + ", 상태 변경: STATE_ENABLED -> STATE_DISABLED");
    checkState(state == STATE_ENABLED);
    formatHolder.clear();
