...
/* package */ final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
  ...
  @Override
  public void prepare() {
    Log.d(TAG_YOHAN, "ExoPlayerImpl.prepare() 호출됨 - 현재 상태: " + playbackInfo.playbackState);
    verifyApplicationThread();
    if (playbackInfo.playbackState != Player.STATE_IDLE) {
      Log.d(TAG_YOHAN, "ExoPlayerImpl.prepare() - 이미 준비됨, 스킵");
      return;
    }
  ...
  public void setPlayWhenReady(boolean playWhenReady) {
    Log.d(TAG_YOHAN, "ExoPlayerImpl.setPlayWhenReady(" + playWhenReady + ") 호출됨");
    verifyApplicationThread();
  ...
  private void setMediaSourcesInternal(
    ...
    Log.d(TAG_YOHAN, "ExoPlayerImpl.setMediaSourcesInternal() - MediaSource 개수: " + mediaSources.size() + ", startWindowIndex: " + startWindowIndex);
    int currentWindowIndex = getCurrentWindowIndexInternal(playbackInfo);
  ...
  private void updatePlayWhenReady(
    ...
    Log.d(TAG_YOHAN, "ExoPlayerImpl.updatePlayWhenReady() - playWhenReady: " + playWhenReady + ", reason: " + playWhenReadyChangeReason);
    ...
    if (playbackInfo.playWhenReady == playWhenReady
      ...
      Log.d(TAG_YOHAN, "ExoPlayerImpl.updatePlayWhenReady() - 상태 변경 없음, 스킵");
      return;
    }
    pendingOperationAcks++;
    ...
    Log.d(TAG_YOHAN, "ExoPlayerImpl.updatePlayWhenReady() - internalPlayer.setPlayWhenReady 호출");
